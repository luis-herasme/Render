...
objetos = [
    [   #       a                      b                    c           d: Vector(200,75,50)
        Vector(50, 25, 50), Vector(50, 25, 25), Vector(50, 50, 25)
    ],
    [
        Vector(50, 25, 50), Vector(50, 50, 50), Vector(50, 50, 25)
    ],
    [
        Vector(150,50,50), Vector(175,75,100), Vector(150,100,50)
    ],
    [
        Vector(150,100,50), Vector(200,75,50), Vector(150,50,50)
    ]
]
...
def main():
    ...
    while running:
        ...
        for b in range(len(objetos)):
            #rotary(objetos[b], ang,  Vector(175,75,100)) 
            rotarx(objetos[b], ang,  Vector(50, 25, 50)) 
